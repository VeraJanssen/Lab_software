...
if Vb_gain != Vb_gain_prev or Vg_gain != Vg_gain_prev:
    ...
    vi.add_variable_scaled('Vg',ivvi,'dac2',1e3/Vg_gain,0*1e3/Vg_gain) #Vg in mV (gain of the gate ampl. is 4 V/V) # .00245
    Vb_gain_prev = Vb_gain
    #Vg_gain_prev = Vg_gain

#ramp up gate and bias to starting values
ramp(vi,'Vg',Vg_fixed,gate_step_init,gate_time)
...
for Vb in Vb_vec: 
    ...
    data.add_data_point(Vg_fixed,Vb,I)
#data.new_block()    
spyview_process(data,Vb_start,Vb_stop,Vg_fixed)
